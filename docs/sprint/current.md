...
| UI-15 | Move Log sticky-bottom races the GTK4 kinetic-scroll animation (the recurring "ui12 scroll flake") | — | — | ✅ Done (PR #29, squash `28d1513`, 2026-09-06; `test_ui12` 20/20 under load + ctest, `ranls-gui-ui-tests` 30/30, `ranls-gui-tests` 209/209) |
